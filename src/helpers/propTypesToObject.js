// code borrowed from https://medium.com/@mrcthms/using-proptype-declarations-to-document-your-react-components-3ba7e18d0a3f
...
const getPropInfo = method => {
	...
	return propTypes.reduce((obj, curr) => {
		...
		if (isCorrect) { // eslint-disable-line
			obj.type = curr;
